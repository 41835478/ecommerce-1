...
use App\Repositories\admin\contracts_documents\ContractsDocumentsContract as rContractsDocuments;
class ContractsDocuments extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.contracts_documents.index', compact('oResults'), compact('aFilterParams'));
    }
    ...
    {
        return view('admin.contracts_documents.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/contracts_documents');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.contracts_documents.show', compact('contracts_documents'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.contracts_documents.edit', compact('contracts_documents'));
    }
