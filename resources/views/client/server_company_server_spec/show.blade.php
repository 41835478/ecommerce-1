...
@section('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.server_company_server_specInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_company_server_spec['cost'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_company_server_spec['period'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-offset-6 col-xs-3">
                            ...
                            <a href="/client/server_company_server_spec/{{ $server_company_server_spec['id'] }}/edit"
