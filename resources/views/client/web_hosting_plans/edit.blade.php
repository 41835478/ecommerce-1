...
@section('content')
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editweb_hosting_plans') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($web_hosting_plans, [
        'method' => 'PATCH',
        'url' => ['/client/web_hosting_plans', $web_hosting_plans->id],
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editweb_hosting_plans') }}</span>
            </div>
