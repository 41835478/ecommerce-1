    ...
    <div id="page-wrapper">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.contracts_renewal_invoice') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <div class=" col-xs-9">
                            <h3 class="box-title m-b-0">{{ trans('general.contracts_renewal_invoiceTableHead') }}</h3>
                            <p class="text-muted m-b-20">{{ trans('general.contracts_renewal_invoiceTableDescription') }}</p>



                        </div>
                        <div class="col-xs-3">
                            <a  href="{{route('client.contracts_renewal_invoice.create')}}"class="btn btn-primary form-control">
                                + {{trans('general.contracts_renewal_invoiceCreate')}}
                            </a>
                        </div>
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('general.contracts'), 'contracts_id', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">
                                        {!! th_sort(trans('general.contracts_renewal'), 'contracts_renewal_id', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">
                                        {!! th_sort(trans('general.invoice'), 'invoice_id', $oResults) !!}
                                    </th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>{{ (isset($oResult->contracts_renewal->to_date))? $oResult->contracts_renewal->price.'( '.$oResult->contracts_renewal->to_date.' )':'' }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="/client/contracts_renewal_invoice/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/client/contracts_renewal_invoice',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/client/contracts_renewal_invoice/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
</div>
                                                </div>
                                        </td>
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('contracts_renewal_id', $aFilterParams['contracts_renewal_id'], ['placeholder'=>trans('general.contracts_renewal_id'),'class'=>'form-control input-sm ']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('invoice_id', $aFilterParams['invoice_id'], ['placeholder'=>trans('general.invoice_id'),'class'=>'form-control input-sm ']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
