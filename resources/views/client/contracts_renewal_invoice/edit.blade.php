    ...
    <div id="page-wrapper">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editcontracts_renewal_invoice') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editcontracts_renewal_invoice') }}</span>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    {!! Form::model($contracts_renewal_invoice, [
                        'method' => 'PATCH',
                        'url' => ['/client/contracts_renewal_invoice', $contracts_renewal_invoice->id],
                    ...
                    <div class="form-group {{ $errors->has('contracts_renewal_id') ? 'has-error' : ''}}  col-xs-6">
                        {!! Form::label('contracts_renewal_id', trans('general.contracts_renewal'), ['class' => 'col-sm-4 control-label']) !!}
                        <div class="col-sm-8">
