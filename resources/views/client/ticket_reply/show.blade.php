...
@section('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.ticket_replyInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$ticket_reply['ticket_id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$ticket_reply['contact_id'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$ticket_reply['description'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$ticket_reply['create_time'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-offset-6 col-xs-3">
                            ...
                            <a href="/client/ticket_reply/{{ $ticket_reply['id'] }}/edit"
