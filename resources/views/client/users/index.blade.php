                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/client/users/create" style="float:right;">
                                    <input name="" class="btn btn-primary btn-flat" type="button"
                                           value="{{ trans('general.addusers') }}"> </a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                                      ...
                                                      <th class="no-warp">{!! th_sort(trans('general.password'), 'password', $oResults) !!}</th>
                                                      ...
                                                      <th class="no-warp">{!! th_sort(trans('general.avatar'), 'avatar', $oResults) !!}</th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/client/users/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/client/users',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/client/users/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
