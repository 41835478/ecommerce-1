...
@section('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.contracts_documentsInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['contracts_id'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['products_id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['name'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['links'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['description'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_documents['type'] }}</label>
                        </div>
                    </div>
