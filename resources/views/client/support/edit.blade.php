            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editsupport') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($support, [
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editsupport') }}</span>
            </div>
        ...
        <div class="row">        <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}} col-xs-6">
            ...
            <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}  col-xs-6">
                ...
                <div class="col-sm-8">
                    {!! Form::select('type',config('array.support_type'), null, ['class' => 'form-control']) !!}
