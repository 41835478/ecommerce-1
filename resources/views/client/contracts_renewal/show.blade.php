    ...
    /*--}}
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.contracts_renewalInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_renewal['id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_renewal['contracts_id'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_renewal['description'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$contracts_renewal['price'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-offset-6 col-xs-3">
                        ...
                        <a href="/client/contracts_renewal/{{ $contracts_renewal['id'] }}/edit"
                           class="fa fa-edit btn btn-primary form-control"> {{trans('general.edit')}}</a>
                    </div>
                    <div class=" col-xs-3">
                        {!! Form::open(['method' => 'DELETE',
                'url' => ['/client/contracts_renewal',$contracts_renewal['id']]]) !!}
