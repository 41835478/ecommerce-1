    ...
    /*--}}
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.server_accessInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                        ...
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{ trans('general.server_ip_id') }}  </label>
                        </div>
                    </div>

                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_access['server_ip_id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_access['type'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{ trans('general.user_name') }}  </label>
                        </div>
                    </div>

                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_access['user_name'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_access['password'] }}</label>
                        </div>
                    </div>
...
@if($canAction)
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-offset-6 col-xs-3">
                            ...
                            <a href="/client/server_access/{{ $server_access['id'] }}/edit"
