            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.server_company') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <div class=" col-xs-9">
                            <h3 class="box-title m-b-0">{{ trans('general.server_companyTableHead') }}</h3>
                            <p class="text-muted m-b-20">{{ trans('general.server_companyTableDescription') }}</p>



                        </div>
                        <div class="col-xs-3">
                            <a  href="{{route('client.server_company.create')}}"class="btn btn-primary form-control">
                                + {{trans('general.server_companyCreate')}}
                            </a>
                        </div>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                                                                ...
                                                                                <td>  <a href="/client/server_company/{{ $oResult->id }}" > {{ $oResult->name }}</a></td>
                                        ...
                                        <td>
                                            ...
                                            'url' => ['/client/server_company',$oResult->id]]) !!}
                                                    <button type="submit" name="Delete" class="deleteRow " >
                                                        <i class="fa fa-trash"></i>

                                                    </button>{!! Form::close() !!}

                                            <a href="/client/server_company/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
</div>
                                                </div>
                                        </td>
