            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editlogtime') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($logtime, [
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editlogtime') }}</span>
            </div>
        ...
        <div class="row">        <div class="form-group {{ $errors->has('support_id') ? 'has-error' : ''}} col-xs-6">
            {!! Form::label('support_id', trans('support_id'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="row">        <div class="form-group {{ $errors->has('hours') ? 'has-error' : ''}} col-xs-6">
            ...
            {!! Form::label('summary', trans('summary'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="row">        <div class="form-group {{ $errors->has('expenses') ? 'has-error' : ''}} col-xs-6">
            {!! Form::label('expenses', trans('expenses'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
