...
@section('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.server_locationsInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_locations['server_company_id'] }}</label>
                        </div>
                    </div>
                        ...
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{ trans('general.location_id') }}  </label>
                        </div>
                    </div>

                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$server_locations['location_id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-offset-6 col-xs-3">
                            ...
                            <a href="/client/server_locations/{{ $server_locations['id'] }}/edit"
