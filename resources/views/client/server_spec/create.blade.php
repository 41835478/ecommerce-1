            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.server_specCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::open(['url' => '/client/server_spec', 'class' => 'form-horizontal']) !!}
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.addserver_spec') }}</span>
            </div>
        ...
        <div class="form-group {{ $errors->has('hard_disk') ? 'has-error' : ''}}  col-xs-6">
            {!! Form::label('hard_disk', trans('general.hard_disk'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="row">
        <div class="form-group {{ $errors->has('cpu') ? 'has-error' : ''}}  col-xs-6">
            {!! Form::label('cpu', trans('general.cpu'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="form-group {{ $errors->has('port') ? 'has-error' : ''}}  col-xs-6">
            {!! Form::label('port', trans('general.port'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="row">
        <div class="form-group {{ $errors->has('ram') ? 'has-error' : ''}}  col-xs-6">
            {!! Form::label('ram', trans('general.ram'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
