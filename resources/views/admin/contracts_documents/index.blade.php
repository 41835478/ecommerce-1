        ...
        <div class="theme-default page-mail">
            ...
            <div class="mail-container ">
                <div class="mail-container-header">
                    {{ trans('general.contracts_documents') }}
                </div>
                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/admin/contracts_documents/create" style="float:right;">
                                    <input name="" class="btn btn-primary btn-flat" type="button"
                                           value="{{ trans('general.addcontracts_documents') }}"> </a>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/admin/contracts_documents/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/admin/contracts_documents',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/admin/contracts_documents/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
