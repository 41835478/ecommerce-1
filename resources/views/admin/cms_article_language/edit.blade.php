...
@section('content')
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('cms_article_language.editcms_article_language') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($cms_article_language, [
        'method' => 'PATCH',
        'url' => ['/admin/cms_article_language', $cms_article_language->id],
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('cms_article_language.editcms_article_language') }}</span>
            </div>
        ...
        <div class="form-group {{ $errors->has("cms_article_id") ? "has-error" : ""}}  col-xs-6" style="display:none">
{!! Form::label("cms_article_id", trans("cms_article_language.cms_article_id"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("cms_article_id", null, ["class" => "form-control","placeholder"=> trans("cms_article_language.cms_article_id")]) !!}
...
<div class="col-sm-8">
    {!! Form::text("cms_language_id", null, ["class" => "form-control","placeholder"=> trans("cms_article_language.cms_language_id")]) !!}
