                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/admin/contracts/create" style="float:right;">
                                    <input name="" class="btn btn-primary btn-flat" type="button"
                                           value="{{ trans('general.addcontracts') }}"> </a>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/admin/contracts/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/admin/contracts',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/admin/contracts/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
