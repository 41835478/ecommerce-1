                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/admin/products_list/create" style="float:right;">
                                    <input name="" class="btn btn-primary btn-flat" type="button"
                                           value="{{ trans('general.addproducts_list') }}"> </a>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/admin/products_list/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/admin/products_list',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/admin/products_list/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
