    ...
    <div id="page-wrapper">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('cms_product.editcms_product') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('cms_product.editcms_product') }}</span>
            </div>
...
<div class="col-sm-8">
    {!! Form::text("cms_category_id", null, ["class" => "form-control","placeholder"=> trans("cms_product.cms_category_id")]) !!}
...
{!! Form::label("created_at", trans("cms_product.created_at"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("created_at", null, ["class" => "form-control","placeholder"=> trans("cms_product.created_at")]) !!}
...
{!! Form::label("updated_at", trans("cms_product.updated_at"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("updated_at", null, ["class" => "form-control","placeholder"=> trans("cms_product.updated_at")]) !!}
...
<div class="col-sm-8">
    ...
    {!! $errors->first("mpn", "<p class='help-block'>:message</p>") !!}
        ...
        <div class="col-sm-offset-9 col-sm-3">
            ...
            {!! Form::hidden("cms_product_id", $cms_product->id) !!}
