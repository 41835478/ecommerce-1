            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('cms_article.cms_articleCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($request,['url' => '/admin/cms_article_language', 'class' => 'form-horizontal']) !!}
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('cms_article.addcms_article') }}</span>
            </div>
...
<div class="col-sm-8">
    ...
    {!! $errors->first("name", "<p class='help-block'>:message</p>") !!}
                ...
                <div class="form-group {{ $errors->has("cms_page_id") ? "has-error" : ""}}  col-xs-4">
                    ...
                    <div class="col-sm-8">
                        {!! Form::select("cms_language_id",config('app.language'), null, ["class" => "form-control","placeholder"=> trans("cms_article.cms_page_id")]) !!}
