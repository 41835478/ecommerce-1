                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/admin/licenses/create" style="float:right;">
                                    <input name="" class="btn btn-primary btn-flat" type="button"
                                           value="{{ trans('general.addlicenses') }}"> </a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                                      ...
                                                      <th class="no-warp">{!! th_sort(trans('general.license'), 'license', $oResults) !!}</th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/admin/licenses/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/admin/licenses',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/admin/licenses/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
