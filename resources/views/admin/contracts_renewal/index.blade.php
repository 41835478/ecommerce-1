                    ...
                    <div class="table-light">
                        <div class="table-header">
                            <div class="table-caption">
                                ...
                                <a href="/admin/contracts_renewal/create" style="float:right;">
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            <a href="/admin/contracts_renewal/{{ $oResult->id }}"
                                               class="fa fa-file-text"></a>


                                            {!! Form::open(['method' => 'DELETE',
                                            'url' => ['/admin/contracts_renewal',$oResult->id]]) !!}
                                            {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}

                                            <a href="/admin/contracts_renewal/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
