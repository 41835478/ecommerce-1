            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('cms_category_description.cms_category_descriptionCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($request,['url' => '/admin/cms_category_description', 'class' => 'form-horizontal']) !!}
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('cms_category_description.addcms_category_description') }}</span>
            </div>
