...
{!! Form::close() !!}
                                ...
                                {!! Form::model($request,['url' => '/common/email_template', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('to_field') ? 'has-error' : ''}}  col-xs-6">
                                        {!! Form::label('to_field', trans('general.to_field'), ['class' => 'col-sm-4 ']) !!}
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group {{ $errors->has('to_email') ? 'has-error' : ''}}  col-xs-6">
                                        {!! Form::label('to_email', trans('general.to_email'), ['class' => 'col-sm-4 ']) !!}
                                        <div class="col-sm-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('subject') ? 'has-error' : ''}}  col-xs-12">
                                        {!! Form::label('subject', trans('general.subject'), ['class' => 'col-sm-2 ']) !!}
                                        <div class="col-sm-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('body') ? 'has-error' : ''}}  col-xs-12">
                                        {!! Form::label('body', trans('general.body'), ['class' => 'col-sm-12 ']) !!}
                                        <div class="col-sm-12">
