...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('permissions', null, ['placeholder'=>trans('users.permissions'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('avatar', null, ['placeholder'=>trans('users.avatar'),'class'=>'form-control input-sm ']) !!}
