...
<section id="wrprojecter" class="login-register" style="background-image:url({{'/assets/'.config('project.layoutAssetsFolder').'/images/backgrounds/signin-bg-'.$random.'.jpg'}}) !important;">
